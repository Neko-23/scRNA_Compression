...
def high_level_decompress(in_path, matrix_path):
    ...
    counts = []
    deltas_file = os.path.join(in_path, "high_level_compress", "deltas.csv")
    ...
    cluster_genes_file = os.path.join(
        in_path, "high_level_compress", "cluster_genes.csv"
    )
    ...
    counts_file = os.path.join(in_path, "high_level_compress", "counts.csv")
